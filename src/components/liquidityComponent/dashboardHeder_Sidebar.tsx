      ...
      <Drawer variant="permanent" open={open}>
        ...
        >
          {[
            {
              text: "Home",
              icon: <img src={sideBarNavHomeIcon} style={{ width: "25px" }} />,
            },
            {
              text: "Deals",
              icon: <img src={sideBarDealsIcon} style={{ width: "22px" }} />,
              right: <CustomSiderBarComp item="9" />,
            },
            {
              text: "Auctions",
              icon: <img src={auctionIcon} style={{ width: "25px" }} />,
              right: (
                <CustomSiderBarComp
                  item={
                    <LockOutlinedIcon
        ...
        >
          ...
          >
            ...
            <AccordionDetails sx={{ px: 0, mt: "-1px" }}>
              <ListItemButton
                sx={{ mb: 1 }}
